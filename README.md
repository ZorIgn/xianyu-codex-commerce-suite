...
- 2026-08-05：在闲鱼卖了 50 多单。高峰期暴露出发货延迟、桌面激活串行等问题，因此增加持久化发货队列、多实例激活和批量凭证更新，并决定将项目开源，供学习、复盘和二次开发。给闲鱼这群人售后太消耗精力，遂开源。
- 2026-06-26 与 2026-08-06 更新记录明确：原有 24 个自动化测试通过，发布整合后共 27 个测试通过；三个真实桌面实例并发尚未验证；真实高峰 P95 尚未压测，不能写成已经验证。
